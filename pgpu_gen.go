...
type PGPURecord struct {
	...
	SupportedVGPUMaxCapacities map[VGPUTypeRef]int64
...
func (_class PGPUClass) GetRemainingCapacity(sessionID SessionRef, self PGPURef, vgpuType VGPUTypeRef) (_retval int64, _err error) {
...
func (_class PGPUClass) GetSupportedVGPUMaxCapacities(sessionID SessionRef, self PGPURef) (_retval map[VGPUTypeRef]int64, _err error) {
