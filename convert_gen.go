...
func convertVGPUTypeRefToIntMapToGo(context string, input interface{}) (goMap map[VGPUTypeRef]int64, err error) {
	xenMap, ok := input.(xmlrpc.Struct)
	if !ok {
		err = fmt.Errorf("Failed to parse XenAPI response: expected Go type %s at %s but got Go type %s with value %v", "xmlrpc.Struct", context, reflect.TypeOf(input), input)
		return
	}
	goMap = make(map[VGPUTypeRef]int64, len(xenMap))
	for xenKey, xenValue := range xenMap {
		keyContext := fmt.Sprintf("%s[%s]", context, xenKey)
		goKey, err := convertVGPUTypeRefToGo(keyContext, xenKey)
		if err != nil {
...
func convertIntToFloatMapToGo(context string, input interface{}) (goMap map[int64]float64, err error) {
	xenMap, ok := input.(xmlrpc.Struct)
	if !ok {
		err = fmt.Errorf("Failed to parse XenAPI response: expected Go type %s at %s but got Go type %s with value %v", "xmlrpc.Struct", context, reflect.TypeOf(input), input)
		return
	}
	goMap = make(map[int64]float64, len(xenMap))
	for xenKey, xenValue := range xenMap {
		keyContext := fmt.Sprintf("%s[%s]", context, xenKey)
...
func convertIntToIntMapToGo(context string, input interface{}) (goMap map[int64]int64, err error) {
	xenMap, ok := input.(xmlrpc.Struct)
	if !ok {
		err = fmt.Errorf("Failed to parse XenAPI response: expected Go type %s at %s but got Go type %s with value %v", "xmlrpc.Struct", context, reflect.TypeOf(input), input)
		return
	}
	goMap = make(map[int64]int64, len(xenMap))
	for xenKey, xenValue := range xenMap {
		keyContext := fmt.Sprintf("%s[%s]", context, xenKey)
		goKey, err := convertIntToGo(keyContext, xenKey)
		if err != nil {
...
func convertIntToStringSetMapToGo(context string, input interface{}) (goMap map[int64][]string, err error) {
	xenMap, ok := input.(xmlrpc.Struct)
	if !ok {
		err = fmt.Errorf("Failed to parse XenAPI response: expected Go type %s at %s but got Go type %s with value %v", "xmlrpc.Struct", context, reflect.TypeOf(input), input)
		return
	}
	goMap = make(map[int64][]string, len(xenMap))
	for xenKey, xenValue := range xenMap {
		keyContext := fmt.Sprintf("%s[%s]", context, xenKey)
		goKey, err := convertIntToGo(keyContext, xenKey)
		if err != nil {
...
func convertStringToIntMapToGo(context string, input interface{}) (goMap map[string]int64, err error) {
	xenMap, ok := input.(xmlrpc.Struct)
	if !ok {
		err = fmt.Errorf("Failed to parse XenAPI response: expected Go type %s at %s but got Go type %s with value %v", "xmlrpc.Struct", context, reflect.TypeOf(input), input)
		return
	}
	goMap = make(map[string]int64, len(xenMap))
	for xenKey, xenValue := range xenMap {
		keyContext := fmt.Sprintf("%s[%s]", context, xenKey)
		goKey, err := convertStringToGo(keyContext, xenKey)
		if err != nil {
...
func convertDRTaskRecordToGo(context string, input interface{}) (record DRTaskRecord, err error) {
	...
	int64roducedSRsValue, ok := rpcStruct["int64roduced_SRs"]
	if ok && int64roducedSRsValue != nil {
		record.IntroducedSRs, err = convertSRRefSetToGo(fmt.Sprintf("%s.%s", context, "int64roduced_SRs"), int64roducedSRsValue)
		if err != nil {
			return
		}
	}
...
func convertSRRecordToGo(context string, input interface{}) (record SRRecord, err error) {
	...
	int64roducedByValue, ok := rpcStruct["int64roduced_by"]
	if ok && int64roducedByValue != nil {
		record.IntroducedBy, err = convertDRTaskRefToGo(fmt.Sprintf("%s.%s", context, "int64roduced_by"), int64roducedByValue)
		if err != nil {
			return
		}
	}
...
func convertEnumVMOperationsToGo(context string, input interface{}) (value VMOperations, err error) {
	...
	case "checkpoint64":
		value = VMOperationsCheckpoint64
...
func convertEnumVmppBackupTypeToGo(context string, input interface{}) (value VmppBackupType, err error) {
	...
	case "checkpoint64":
		value = VmppBackupTypeCheckpoint64
	default:
...
func convertIntSetToGo(context string, input interface{}) (slice []int64, err error) {
	set, ok := input.([]interface{})
	if !ok {
		err = fmt.Errorf("Failed to parse XenAPI response: expected Go type %s at %s but got Go type %s with value %v", "[]interface{}", context, reflect.TypeOf(input), input)
		return
	}
	slice = make([]int64, len(set))
	for index, item := range set {
		itemContext := fmt.Sprintf("%s[%d]", context, index)
		...
		slice[index] = int64(itemValue)
	}
	return
}

func convertIntToGo(context string, input interface{}) (value int64, err error) {
...
func convertIntToXen(context string, value int64) (string, error) {
